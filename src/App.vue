        ...
        <main class="celquoteoptions-main">
          <el-form>
            ...
            <el-form-item label="天神主题色">
              <el-color-picker
                v-model="celQuoteOptionsFormValue.color"
            ...
            <el-form-item
              v-show="celQuoteOptionsFormValue.bgType === 'symbol'"
              label="字符（仅支持单个）"
            >
              <el-autocomplete
                maxlength="1"
            ...
            <el-form-item
              v-show="celQuoteOptionsFormValue.bgType === 'icon'"
            ...
            <el-form-item v-show="celQuoteOptionsFormValue.bgType === 'img'" label="图片预览">
              ...
              <el-image
                v-else
                :src="celQuoteOptionsFormValue.bg.img"
